...
// ==================== ФРАЗЫ ДЛЯ ХОДА БАНКА (100+) ====================
const BANK_TURN_PHRASES = [
  '🏴‍☠️ "А теперь мой черёд, щенок!" 🏴‍☠️',
  '💀 "Смотри, как бросает капитан!" 💀',
  '⚓ "Держись, сейчас я покажу класс!" ⚓',
  '🦜 "Попугай сказал: «Банк выиграет!»" 🦜',
  '🔥 "Готовься к поражению!" 🔥',
  '🗡️ "Моя шпага острее твоей удачи!" 🗡️',
  '💎 "Сокровище будет моим!" 💎',
  '🌊 "Волны на моей стороне!" 🌊',
  '☠️ "Ты дрожишь, пират?" ☠️',
  '🏆 "Этот трофей мой по праву!" 🏆',
  '💰 "Дублоны текут ко мне!" 💰',
  '⚔️ "Бой только начинается!" ⚔️',
  '🛡️ "Мой щит выдержит любой удар!" 🛡️',
  '🔱 "Трезубец удачи в моих руках!" 🔱',
  '🧨 "Сейчас рванёт!" 🧨',
  '🎯 "Я всегда попадаю в цель!" 🎯',
  '💥 "Твой проигрыш неизбежен!" 💥',
  '🌟 "Звёзды ведут меня к победе!" 🌟',
  '🌈 "Удача улыбнулась мне!" 🌈',
  '🍀 "Четырёхлистный клевер у меня!" 🍀',
  '🧙 "Магия банка сильнее!" 🧙',
  '🧝 "Эльфийская удача на моей стороне!" 🧝',
  '🧛 "Я выпью твою удачу!" 🧛',
  '🧟 "Зомби-банк не остановить!" 🧟',
  '🧚 "Фея удачи танцует для меня!" 🧚',
  '🧜 "Русалка шепчет мне числа!" 🧜',
  '🧞 "Джинн исполнил моё желание!" 🧞',
  '🏹 "Лук удачи натянут!" 🏹',
  '🗡️ "Клинок судьбы занесён!" 🗡️',
  '⚜️ "Геральдика победы украшает мой герб!" ⚜️',
  '🍺 "Кружка эля за мой бросок!" 🍺',
  '🥃 "Ром поднимает настроение!" 🥃',
  '🍹 "Пина колада для победителя!" 🍹',
  '🎏 "Карп удачи плывёт ко мне!" 🎏',
  '🎐 "Ветер удачи дует в мои паруса!" 🎐',
  '🏮 "Фонарь победы горит ярко!" 🏮',
  '🎇 "Фейерверк в мою честь!" 🎇',
  '🌌 "Галактика на моей стороне!" 🌌',
  '🛸 "Инопланетная удача прибыла!" 🛸',
  '🤖 "Робот-банк вычисляет победу!" 🤖',
  '👾 "Игровой бросок за мной!" 👾',
  '🎮 "Я прохожу этот уровень!" 🎮',
  '🕹️ "Джойстик удачи в моих руках!" 🕹️',
  '🐉 "Дракон удачи дышит огнём!" 🐉',
  '🐙 "Кракен поднимается из пучины!" 🐙',
  '🦈 "Акула удачи плывёт за тобой!" 🦈',
  '⛵ "Паруса полны ветра победы!" ⛵',
  '🏝️ "Остров сокровищ уже близко!" 🏝️',
  '🧭 "Компас показывает на победу!" 🧭',
  '🪙 "Монеты сыпятся дождём!" 🪙',
  '⚓ "Якорь брошен в удачу!" ⚓',
  '💀 "Кости брошены!" 💀',
  '🔥 "Огненный бросок!" 🔥',
  '⚡ "Молниеносная удача!" ⚡',
  '🌪️ "Ураган сметает всех!" 🌪️',
  '☠️ "Пиратская сага продолжается!" ☠️',
  '🏚️ "Таверна ждёт победителя!" 🏚️',
  '🔮 "Хрустальный шар предсказывает победу!" 🔮',
  '🧿 "Сглаз не страшен банку!" 🧿',
  '🌵 "Кактус удачи расцвёл!" 🌵',
  '🌴 "Пальма сокровищ ждёт!" 🌴',
  '🍀 "Клевер принёс удачу!" 🍀',
  '🌿 "Ветка лавра для победителя!" 🌿',
  '🍃 "Лист удачи упал на мою сторону!" 🍃',
  '🍂 "Осенний триумф!" 🍂',
  '🍁 "Кленовый лист победы!" 🍁',
  '🌾 "Золотая нива удачи!" 🌾',
  '🌽 "Кукуруза удачи созрела!" 🌽',
  '🍎 "Яблоко победы сорвано мной!" 🍎',
  '🍐 "Груша фортуны сладка!" 🍐',
  '🍊 "Апельсин счастья для банка!" 🍊',
  '🍋 "Лимон удачи освежает!" 🍋',
  '🍌 "Банан победы придаёт сил!" 🍌',
  '🍇 "Виноград триумфа созрел!" 🍇',
  '🍓 "Клубника удачи слаще мёда!" 🍓',
  '🫐 "Черника фортуны дарит энергию!" 🫐',
  '🍒 "Вишня победы сладка!" 🍒',
  '🍑 "Персик счастья тает во рту!" 🍑',
  '🍍 "Ананас удачи ждёт!" 🍍',
const BANK_TURN_PHRASES = [
  '🏴‍☠️ А теперь мой черёд, щенок, смотри в оба.',
  ...
  '🗡️ Шпага остра, а бросок ещё острее.',
  '💎 Клад не для таких, как ты.',
  '🌊 Шторм на подходе, и я им управляю.',
  '☠️ Череп ухмыляется, глядя на тебя.',
  '🏆 Этот трофей мой, даже не надейся.',
  '💰 Сундук заперт, а ключ у меня.',
  '⚔️ Выхожу на абордаж, прячь свои дублоны.',
  '🛡️ Мой борт выдержит твой жалкий залп.',
  ...
  '🗡️ Клинок судьбы занесён над тобой.',
  '⚜️ Мой герб будет украшен лаврами.',
  ...
  '🕹️ Штурвал в моих руках, я веду к победе.',
  ...
  '🏝️ Остров сокровищ виден, я почти у цели.',
  ...
  '🌪️ Ураган развеет твои жалкие попытки.',
  '☠️ Череп и кости — мой флаг, он реет над тобой.',
  '🏚️ Таверна будет ждать меня, а не тебя.',
  ...
  '🗡️ Клинок сверкает, страх в твоих глазах.',
  '🏴‍☠️ Флаг взвился, а ты уже дрожишь.',
...
const BANK_TURN_PHRASES = [
  ...
  '⚓ Держи курс на поражение, матрос. 🦜',
  '🦜 Попугай уже каркнул твой проигрыш. 🔥',
  '🔥 Поднимаю паруса, ухожу в отрыв. 🗡️',
  '🗡️ Шпага остра, а бросок ещё острее. 💎',
  '💎 Клад не для таких, как ты. 🌊',
  '🌊 Шторм на подходе, и я им управляю. ☠️',
  '☠️ Череп ухмыляется, глядя на тебя. 🏆',
  '🏆 Этот трофей мой, даже не надейся. 💰',
  '💰 Сундук заперт, а ключ у меня. ⚔️',
  ...
  '🧜 Русалка шепчет мне правильные числа. 🧞',
  '🧞 Джинн на моей стороне, не спорь. 🏹',
  '🏹 Лук натянут, стрела улетит в победу. 🗡️',
  ...
  '🤖 Мой расчёт точнее твоей интуиции. 👾',
  '👾 Я сбил твой корабль одним ударом. 🎮',
  '🎮 Я прошёл этот уровень тысячи раз. 🕹️',
  '🕹️ Штурвал в моих руках, я веду к победе. 🐉',
  '🐉 Дракон в трюме уже проснулся. 🐙',
  '🐙 Кракен поднимет твой корабль на дно. 🦈',
  '🦈 Акула удачи уже кружит за тобой. ⛵',
  '⛵ Мои паруса полны ветра, а твои — страха. 🏝️',
  '🏝️ Остров сокровищ виден, я почти у цели. 🧭',
  '🧭 Компас показывает только на победу. 🪙',
  '🪙 Монеты падают к моим ногам, слышишь? ⚓',
  '⚓ Якорь брошен, и он принёс мне удачу. 💀',
  '💀 Кости сказали своё слово, слушай. 🔥',
  '🔥 Пороховой залп сметёт твои надежды. ⚡',
  '⚡ Молния удачи сверкает надо мной. 🌪️',
  ...
  '⚡ Я направляю удар в твой киль. 🔥',
  '🔥 Канделябры горят, а удача моя. 🌊',
  '🌊 Волны играют со мной, а не с тобой. 🗡️',
  ...
  '🏹 Моя стрела всегда находит цель, а ты — нет. 🗡️',
...
// ==================== АНИМАЦИЯ СТИКЕРОВ (С ХОДОМ БАНКА) ====================
async function sendDiceAnimation(chatId, playerDice1, playerDice2, bankDice1, bankDice2) {
  try {
    ...
    // 4. Два кубика банка ОДНОВРЕМЕННО
