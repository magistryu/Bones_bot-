...
const WIN_PHRASES = [
  ...
  '🗝️ "Сокровище ждало тебя!" 🗝️',
  '⚓ "Якорь счастья брошен!" ⚓',
  '💰 "Богатство — твой удел!" 💰'
];

const LOSE_PHRASES = [
  '💀 "Тысяча чертей! В следующий раз повезёт!" 💀',
  '🗡️ "Проклятые кости!" 🗡️',
  '🌊 "Волна унесла удачу..." 🌊',
  '💀 "Череп сегодня не на твоей стороне!" 💀',
  '⚓ "Якорь упал на дно..." ⚓',
  '🏴‍☠️ "Флаг приспущен..." 🏴‍☠️',
  '🗡️ "Ржавый клинок сегодня..." 🗡️',
  '💀 "Даже попугай отвернулся!" 💀',
  '🌊 "Шторм неудач..." 🌊',
  '⚓ "Судно дало течь..." ⚓',
  '🏴‍☠️ "Пиратская удача покинула тебя!" 🏴‍☠️',
  '🗡️ "Шпага сломалась..." 🗡️',
  '💀 "Морской дьявол помешал!" 💀',
  '🌊 "Волны сегодня жестоки!" 🌊',
  '⚓ "Якорь на дне..." ⚓',
  '🏴‍☠️ "Флаг вниз, капитан!" 🏴‍☠️',
  '🗡️ "Оружие сегодня не в руку!" 🗡️',
  '💀 "Череп смеётся над тобой!" 💀',
  '🌊 "Море выбрало другого!" 🌊',
  '⚓ "Судно село на мель!" ⚓',
  '🏴‍☠️ "Пиратский совет не одобряет!" 🏴‍☠️',
  '🗡️ "Клинок затупился..." 🗡️',
  '💀 "Фортуна отвернулась!" 💀',
  '🌊 "Ты попал в шторм!" 🌊',
  '⚓ "Якорь потерян..." ⚓',
  '🏴‍☠️ "Флаг пирата в крови!" 🏴‍☠️',
  '🗡️ "Шпага выпала из рук!" 🗡️',
  '💀 "Смерть смеётся последней!" 💀',
  '🌊 "Волны унесли твои надежды!" 🌊',
  '⚓ "Судно разбито о скалы!" ⚓',
  '🏴‍☠️ "Пиратский дух сломлен!" 🏴‍☠️',
  '🗡️ "Клинок не выдержал!" 🗡️',
  '💀 "Череп победил!" 💀',
  '🌊 "Море сегодня злое!" 🌊',
  '⚓ "Якорь утонул..." ⚓',
  '🏴‍☠️ "Флаг — чёрный цвет!" 🏴‍☠️',
  '🗡️ "Бой проигран..." 🗡️',
  '💀 "Пиратская карма догнала!" 💀',
  '🌊 "Шторм сильнее тебя!" 🌊',
  '⚓ "Судно тонет..." ⚓',
  '🏴‍☠️ "Удача была не с тобой!" 🏴‍☠️',
  '🗡️ "Шпага в руке дрогнула!" 🗡️',
  '💀 "Череп забрал победу!" 💀',
  '🌊 "Волны унесли твою удачу!" 🌊',
  '⚓ "Якорь — символ поражения!" ⚓',
  '🏴‍☠️ "Флаг склонён!" 🏴‍☠️',
  '🗡️ "Клинок сломан!" 🗡️',
  '💀 "Фортуна не на твоей стороне!" 💀',
  '🌊 "Море безжалостно!" 🌊',
  '⚓ "Судно проиграло битву!" ⚓'
];

const DRAW_PHRASES = [
  '🤝 "Братан, ничья!" 🤝',
  '⚓ "Море уравняло шансы!" ⚓',
  '🏴‍☠️ "Пиратская честь не позволяет проигрывать!" 🏴‍☠️',
  '💀 "Череп улыбается обоим!" 💀',
  '🗡️ "Шпаги скрестились в ничью!" 🗡️',
  '🌊 "Волны не выбрали победителя!" 🌊',
  '🦜 "Попугай кричит: «Братва, ничья!»" 🦜',
  '💎 "Золото поделено поровну!" 💎',
  '🗝️ "Клад остался при своих!" 🗝️',
  '🔥 "Ничья — честный итог!" 🔥',
  '⚓ "Якорь успокоился!" ⚓',
  '🏴‍☠️ "Флаг не склоняется!" 🏴‍☠️',
  ...
  '🏴‍☠️ "Флаг на месте!" 🏴‍☠️',
  '💀 "Фортуна нейтральна!" 💀',
  '🗡️ "Шпаги сплетены в дружбе!" 🗡️',
  '🌊 "Волны успокоились!" 🌊',
  '🦜 "Попугай качает головой!" 🦜',
  '💎 "Золото не ушло!" 💎',
  '🗝️ "Ключ остался в замке!" 🗝️',
  '🔥 "Пламя ровное!" 🔥',
  '⚓ "Судно на месте!" ⚓',
  '🏴‍☠️ "Пиратский совет — ничья!" 🏴‍☠️',
  '💀 "Череп улыбается!" 💀',
  '🗡️ "Клинки скрестились!" 🗡️',
  '🌊 "Море сохранило тайну!" 🌊',
  '🦜 "Попугай молчит!" 🦜',
  '💎 "Сокровище не тронуто!" 💎',
  '🗝️ "Клад не взят!" 🗝️',
  '🔥 "Огонь погас!" 🔥',
  '⚓ "Якорь на месте!" ⚓',
  '🏴‍☠️ "Флаг не поднят!" 🏴‍☠️',
...
bot.on('message', async (msg) => {
  ...
  if (!isNaN(amount) && amount >= 1) {
    ...
    if (p.currentMode === 'vip') {
      ...
      if (balance < amount) {
        bot.sendMessage(id, formatMessage('VIP', `❌ Не хватает.
        return;
      }
      p.balance = safeNumber(p.balance) - amount;
      const playerDice = Math.floor(Math.random() * 6) + 1;
