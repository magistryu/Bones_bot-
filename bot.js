...
bot.on('callback_query', async (query) => {
  ...
  if (data.startsWith('roll_classic_')) {
    ...
    const resultMsg = `${playerSum > bankSum ? '✅ Ты выиграл!' : playerSum < bankSum ? '❌ Ты проиграл!' : '🤝 Ничья!'}\n\n` +
